...
@section('contenu')
    <main class="mentions-legales">
        ...
        <div class="article01">
            ...
            <div>
                ...
                <p class="part12">
                    ...
                    Directeur de la publication : Jimmy GILBERT.
                </p>
                <p class="part13">
        ...
        <!-- Collecte des données via le formulaire de contact -->

        <div class="article05">
            <h2>Article 5 – Collecte et protection des données</h2>
            <p>
                <p>Vos données sont collectées par le site 'Passionné de Formule 1' dans le formulaire de contact.</p>
                ...
                <p>Les données personnelles collectées pour le formulaire de contact sont les suivantes&nbsp;:</p>
                <ul>
                    <li>Nom et prénom.</li>
                    <li>Adresse email.</li>
        ...
        <div class="article06">
            ...
            <p>
                ...
                <ul>
                    ...
                    <li>La durée de vie de ces cookies est de six mois.</li>
                </ul>
